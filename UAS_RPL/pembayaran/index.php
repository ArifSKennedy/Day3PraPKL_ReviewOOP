  ...
  <body class="bottomAnim">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../uas/index.php">Jurusan <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    <thead class="bg-primary">
                        <tr>
                        <th scope="col">No</th>
                        <th scope="col">kode_pembayaran</th>
                        <th scope="col">nama</th>
                        <th scope="col">tanggal_pembayaran</th>
                        <th scope="col">uang_pendaftaran</th>
                        <th scope="col">uang_seragam</th>
                        <th scope="col">uang_kegiatan</th>
                        <th scope="col">total_pembayaran</th>
                        <th scope="col"><th>
                    ...
                    <tbody>
                        ...
                        <?php
                            $total_pembayaran = $data['uang_pendaftaran'] + $data['uang_seragam'] + $data['uang_kegiatan'];
                        ?>
