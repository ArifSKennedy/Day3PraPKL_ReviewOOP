            ...
            <form action="" method="">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" value="<?php echo $kode_jurusan; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Jurusan</label>
                        <input type="text" class="form-control" name="mata_kuliah" value="<?php echo $jurusan; ?>" disabled>
                    </div>
                </form>
